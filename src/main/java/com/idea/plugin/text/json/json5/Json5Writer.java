...
import static com.idea.plugin.text.json.json5.JsonScope.*;
 ...
 * - A strict JSON only mode has been added which will only writeDoc valid JSON.
 * - Writer changes to handle JSON5 syntax extensions.
 * - Add ability to writeDoc comments into the writer.
 * - Repackaged.
 ...
 * necessary:
 * <ul>
 *   <li>To writeDoc <strong>arrays</strong>, first call {@link #beginArray()}.
 *       Write each of the array's elements with the appropriate {@link #value}
 *       methods or by nesting other arrays and objects. Finally close the array
 *       using {@link #endArray()}.
 *   <li>To writeDoc <strong>objects</strong>, first call {@link #beginObject()}.
 ...
 *   }}</pre>
 *
 * <p>Each {@code JsonWriter} may be used to writeDoc a single JSON stream.
...
public final class Json5Writer implements Closeable, Flushable {
     ...
     *
     * @param comment the comment to writeDoc, or null to encode nothing.
     */
